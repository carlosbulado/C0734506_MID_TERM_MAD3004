...
// Question #2
var p1: Product = Product(id: 1, pId: "P001", name: "SAMSUNG", pName: "Hard Drive", price: 120.0, quantity: 8.0)
var p2: Product = Product(id: 2, pId: "P002", name: "SAMSUNG", pName: "ZIP Drive", price: 90.0, quantity: 8.0)
var p3: Product = Product(id: 3, pId: "P003", name: "SAMSUNG", pName: "Floppy Disk", price: 50.0, quantity: 4.0)
var p4: Product = Product(id: 4, pId: "P004", name: "APPLE", pName: "Monitor 27'", price: 300.0, quantity: 3.0)
var p5: Product = Product(id: 5, pId: "P005", name: "APPLE", pName: "iPhone 7+", price: 900.0, quantity: 3.0)
// Question #3
